...
data_pbsubreads_links: aws s3 --no-sign-request sync s3://genomeark/species/Denticeps_clupeoides/fDenClu1/genomic_data/pacbio/ . --exclude "*scraps.bam* --exclude "*ccs.bam*"<br>

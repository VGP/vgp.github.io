...
data_pbsubreads_links: aws s3 --no-sign-request sync s3://genomeark/species/Erpetoichthys_calabaricus/fErpCal1/genomic_data/pacbio/ . --exclude "*scraps.bam* --exclude "*ccs.bam*"<br>
